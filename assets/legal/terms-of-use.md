...
Our Privacy Policy explains what we collect and how it is used. It forms part of these Terms. You can review, correct, or delete your account and data inside the App (password confirmation is required). When deletion is confirmed, data leaves active systems immediately and is removed from backups on the next purge cycle. The App does not capture your precise GPS location and does not serve advertising. We log sign-in times ("last active") for security and troubleshooting.

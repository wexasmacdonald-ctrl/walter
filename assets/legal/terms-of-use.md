...
The App relies on service providers such as database or authentication platforms, hosting and CDN services, build or delivery services, and map or geocoding providers. Using the App means you also accept the terms required by those services. We are not responsible for providers we do not control.
...
Termination
You may stop using the App at any time. We may suspend or terminate access immediately if you violate these Terms, if a third-party provider requires it, or if the law demands it. Once terminated, your license ends and you must stop using the App. In-app tools let you delete your account or data.

App Store Terms
If you downloaded the App from Apple or Google, the applicable store terms also apply, and you agree to follow them wherever they impose additional requirements.

Governing Law and Venue
These Terms are governed by the laws of the Province of Ontario and the federal laws of Canada, without regard to conflict-of-laws principles. Courts located in Ottawa, Ontario have exclusive jurisdiction, and you consent to personal jurisdiction there.

Changes
We may revise these Terms. Material updates will be communicated through reasonable notice, and continuing to use the App after changes take effect constitutes acceptance.

Effective Date, Owner, and Contact
Effective: November 7, 2025
MacDonald AI, Ottawa, Ontario, Canada
Owner: Joseph MacDonald
